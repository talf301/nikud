...
require('lazy').setup({
  ...
  -- },
  {
    ...
    priority = 1000,
    config = function()
      require('catppuccin').setup({ flavor = 'frappe', background = { dark = 'frappe' } })
...
wk.register({
  ["<leader>"] = {
    ...
    s = {
      ...
      g = { require('telescope.builtin').live_grep, "Fuzzy search project" }
    },
    -- Git
    g = {
      name = "git",
...
-- Special terminal key
vim.keymap.set('n', '<leader>t', '<CMD>lua require("FTerm").toggle()<CR>', { desc = "Toggle floating terminal" })
...
vim.g.gitblame_message_when_not_committed = '    You (local)'
-- gitlinker
